...
const validateTask = (task) => {
    const schema = joi_1.default.object({
        ...
        status: joi_1.default.string().valid("todo", "inprogress", "complete", "backlog", "blocked").required(),
    });
...
const validateTaskUpdate = (task) => {
    const schema = joi_1.default.object({
        ...
        description: joi_1.default.string().max(500).optional(),
        status: joi_1.default.string().valid("todo", "inprogress", "complete", "backlog", "blocked").optional(),
    });
    return schema.validate(task);
};
